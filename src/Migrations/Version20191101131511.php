 ...
 */
final class Version20191101131511 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__teacher AS SELECT id, login, password, name, surname FROM teacher');
        $this->addSql('DROP TABLE teacher');
        $this->addSql('CREATE TABLE teacher (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, password VARCHAR(64) NOT NULL COLLATE BINARY, name VARCHAR(64) NOT NULL COLLATE BINARY, surname VARCHAR(64) NOT NULL COLLATE BINARY, username VARCHAR(64) NOT NULL)');
        $this->addSql('INSERT INTO teacher (id, username, password, name, surname) SELECT id, login, password, name, surname FROM __temp__teacher');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE __temp__student');
        $this->addSql('CREATE INDEX IDX_B723AF337648EE39 ON student (module_id_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__teacher AS SELECT id, username, password, name, surname FROM teacher');
        $this->addSql('DROP TABLE teacher');
        $this->addSql('CREATE TABLE teacher (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, password VARCHAR(64) NOT NULL, name VARCHAR(64) NOT NULL, surname VARCHAR(64) NOT NULL, login VARCHAR(64) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO teacher (id, login, password, name, surname) SELECT id, username, password, name, surname FROM __temp__teacher');
        $this->addSql('DROP TABLE __temp__teacher');
    }
}
