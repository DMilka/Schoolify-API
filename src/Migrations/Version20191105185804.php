 ...
 */
final class Version20191105185804 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__module AS SELECT id, teacher_id_id, average_type_id_id, name FROM module');
        ...
        $this->addSql('INSERT INTO module (id, teacher_id_id, average_type_id_id, name) SELECT id, teacher_id_id, average_type_id_id, name FROM __temp__module');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__teacher AS SELECT id, password, name, surname, username, email FROM teacher');
        $this->addSql('DROP TABLE teacher');
        $this->addSql('CREATE TABLE teacher (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, password VARCHAR(64) NOT NULL COLLATE BINARY, name VARCHAR(64) NOT NULL COLLATE BINARY, surname VARCHAR(64) NOT NULL COLLATE BINARY, username VARCHAR(64) NOT NULL COLLATE BINARY, email VARCHAR(64) NOT NULL)');
        $this->addSql('INSERT INTO teacher (id, password, name, surname, username, email) SELECT id, password, name, surname, username, email FROM __temp__teacher');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE __temp__student');
        $this->addSql('CREATE INDEX IDX_B723AF337648EE39 ON student (module_id_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__teacher AS SELECT id, username, password, name, email, surname FROM teacher');
        $this->addSql('DROP TABLE teacher');
        $this->addSql('CREATE TABLE teacher (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, username VARCHAR(64) NOT NULL, password VARCHAR(64) NOT NULL, name VARCHAR(64) NOT NULL, surname VARCHAR(64) NOT NULL, email VARCHAR(64) DEFAULT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO teacher (id, username, password, name, email, surname) SELECT id, username, password, name, email, surname FROM __temp__teacher');
        $this->addSql('DROP TABLE __temp__teacher');
    }
}
