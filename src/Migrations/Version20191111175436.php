 ...
 */
final class Version20191111175436 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__module AS SELECT id, teacher_id_id, average_type_id_id, name, class_name, start_date, end_date FROM module');
        $this->addSql('DROP TABLE module');
        $this->addSql('CREATE TABLE module (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, teacher_id_id INTEGER NOT NULL, average_type_id_id INTEGER NOT NULL, name VARCHAR(64) NOT NULL COLLATE BINARY, class_name VARCHAR(64) NOT NULL COLLATE BINARY, start_date DATETIME NOT NULL, end_date DATETIME DEFAULT NULL, CONSTRAINT FK_C242628EAE7025E FOREIGN KEY (average_type_id_id) REFERENCES average_type (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_C2426282EBB220A FOREIGN KEY (teacher_id_id) REFERENCES teacher (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO module (id, teacher_id_id, average_type_id_id, name, class_name, start_date, end_date) SELECT id, teacher_id_id, average_type_id_id, name, class_name, start_date, end_date FROM __temp__module');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_C242628EAE7025E');
        $this->addSql('DROP INDEX IDX_C2426282EBB220A');
        $this->addSql('CREATE TEMPORARY TABLE __temp__module AS SELECT id, average_type_id_id, teacher_id_id, name, start_date, end_date, class_name FROM module');
        $this->addSql('DROP TABLE module');
        $this->addSql('CREATE TABLE module (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, average_type_id_id INTEGER NOT NULL, teacher_id_id INTEGER NOT NULL, name VARCHAR(64) NOT NULL, start_date DATETIME NOT NULL, end_date DATETIME DEFAULT NULL, class_name VARCHAR(64) NOT NULL)');
        $this->addSql('INSERT INTO module (id, average_type_id_id, teacher_id_id, name, start_date, end_date, class_name) SELECT id, average_type_id_id, teacher_id_id, name, start_date, end_date, class_name FROM __temp__module');
        $this->addSql('DROP TABLE __temp__module');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_C242628EAE7025E ON module (average_type_id_id)');
        $this->addSql('CREATE INDEX IDX_C2426282EBB220A ON module (teacher_id_id)');
        $this->addSql('DROP INDEX IDX_B723AF337648EE39');
