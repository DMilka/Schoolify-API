 ...
 */
final class Version20191103223929 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE teacher ADD COLUMN email VARCHAR(64) NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE teacher (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, username VARCHAR(64) NOT NULL, password VARCHAR(64) NOT NULL, name VARCHAR(64) NOT NULL, surname VARCHAR(64) NOT NULL)');
        $this->addSql('INSERT INTO teacher (id, username, password, name, surname) SELECT id, username, password, name, surname FROM __temp__teacher');
