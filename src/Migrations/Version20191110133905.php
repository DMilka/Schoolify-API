 ...
 */
final class Version20191110133905 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE module');
        $this->addSql('CREATE TABLE module (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, average_type_id_id INTEGER NOT NULL, teacher_id_id INTEGER NOT NULL, name VARCHAR(64) NOT NULL, class_name VARCHAR(64) NOT NULL, start_date DATE NOT NULL, end_date DATE DEFAULT NULL)');
